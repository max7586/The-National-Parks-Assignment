...
function displayResults(responseJson, maxResults) {
    ...
    for (let i = 0; i < responseJson.data.length && i < maxResults; i++) {
        ...
        // https: //www.google.com/maps/search/at:40.41029575,+long:-76.4337548/
    }
...
function getParks(baseUrl, stateArr, maxResults, apiKey) {
    ...
    //         $('.js-error').text(`We have ${responseJson.data.length} parks for you'r state`);
...
function watchForm() {
    $('.js-form').on('submit', function() {
        ...
        const apiKey = '1GjUQdpoLiGF431iyJZyYfF2MP9xtoYB3HcyaFgI'
